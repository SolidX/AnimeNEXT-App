    ...
    return (
        <Fragment>
            ...
            <ol>
                ...
                <li>No projectiles of any kind will be permitted. Examples include, but are not limited to: Airsoft guns, NERF guns, BB and other pellet guns, paintball guns, crossbows, dart guns, blowguns, and water guns.
                <ol>
